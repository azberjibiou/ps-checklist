...
CREATE TABLE `Problem` (
    ...
    `editorialLink` VARCHAR(191) NULL,
...
CREATE TABLE `UserProblemStatus` (
    ...
    `status` ENUM('SOLVED', 'ATTEMPTING', 'FAILED') NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Contest` ADD CONSTRAINT `Contest_categoryId_fkey` FOREIGN KEY (`categoryId`) REFERENCES `Category`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
